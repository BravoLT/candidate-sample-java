...
public class PaymentService {
    ...
    public List<PaymentDto> retrieveByUserId(final String userId) {
        final List<Payment> userPayments = paymentRepository.findByUserId(userId);
        LOGGER.info("found {} payments for user {}", userPayments.size(), userId);

        return resourceMapper.convertPayments(userPayments);
    }
}
