...
public class PaymentControllerTest {
    ...
    void getRetrieveByUserId() throws Exception {
        ...
        final ResultActions result = this.mockMvc
                .perform(get("/payment/retrieve/18bf879b-bcb4-411f-974c-df5dcdccbffe"));
        ...
        verify(paymentService).retrieveByUserId(
                eq("18bf879b-bcb4-411f-974c-df5dcdccbffe"), eq(pageRequest), any(HttpServletResponse.class)
        );
    }

    @Test
    void getRetrieveByUserIdEmpty() throws Exception {
